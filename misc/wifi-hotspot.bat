...
echo Unknown action, please enter a number.
pause
goto start
...
echo Temporary hotspots will vanish after a restart
echo Enter the marked letter of your prefered option [t/p]
set /p set_permanent=
