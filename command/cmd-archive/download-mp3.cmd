...
echo.
echo Enter a YouTube link below:
goto option_1
...
echo.
echo.
echo Where are my files?
echo In a folder called 'audio' located in the SAME directory/folder as this script.
echo.
echo.
echo How do I paste?
echo Right click inside the terminal.
echo. 
echo.
echo 1. Yes.
echo 2. No.
